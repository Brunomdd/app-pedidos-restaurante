  ...
  return (
     <header className="bg-zinc-900 text-white px-4 py-4 relative">
        <div className="flex items-center justify-between w-full mx-auto max-w-7xl">
          <div className="text-lg font-bold">Restaurante</div>
        ...
        {isMobile ? (
            ...
            <nav
              ref={menuRef}
              className={`fixed top-0 right-0 h-auto w-48 bg-zinc-900 shadow-lg p-4 transform ${
            ...
            >
              <ul className="flex flex-col items-start gap-4 text-sm md:text-base w-full">
                ...
                <li>
                  <Link
                    href="/cadastro"
                    className="bg-blue-500 px-4 py-2 rounded hover:bg-blue-600 transition block text-center"
                  >
                    Cadastro/Login
                  </Link>
                </li>
